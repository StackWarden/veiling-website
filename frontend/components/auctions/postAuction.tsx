...
export default function PostAuction() {
  ...
  const handleChange = (key: keyof Auction, value: string | string[]) => {
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-4xl space-y-8">
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            className="mt-1 w-full border border-gray-300 rounded-lg p-3 min-h-[100px]"
          />
        </div>
        ...
        {postError && (
          <p className="text-red-600 text-center font-semibold">{postError}</p>
        )}
      </form>
    </div>
  );
